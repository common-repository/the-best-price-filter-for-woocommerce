...
{
    /**
     * public makes overriding always possible
     */
    public $type = tbwpf_OptPropertyTypes::UNDEFINED;
    public $sqlType = 'undefined';
    public $sqlCast = 'undefined';
    public $cast = 'floatval';
